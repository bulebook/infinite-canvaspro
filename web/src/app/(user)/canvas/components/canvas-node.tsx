...
import { ChevronRight, Image as ImageIcon, Music2, RefreshCw, Star, Video, Box } from "lucide-react";
...
const nodeContentRenderers = {
    ...
    [CanvasNodeType.Audio]: AudioNodeContent,[CanvasNodeType.Director3D]: Director3DNodeContent,
...
function Director3DNodeContent({ node, theme }: NodeContentRendererProps) {
    return (
        <div className="flex h-full w-full flex-col items-center justify-center gap-2" style={{ color: theme.node.placeholder }}>
            <Box className="size-7 opacity-35" />
            <span className="text-sm">3D Director</span>
        </div>
    );
}
